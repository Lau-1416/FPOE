...
class ServiciosApp:
    def __init__(self, ventana):
        ...
        tk.Label(self.frame, text="Descripción:").grid(row=4, column=1, columnspan=2, pady=5)
        self.txtDescripcion = tk.Entry(self.frame)
        self.txtDescripcion.grid(row=5, column=1, columnspan=2, padx=30, pady=5)

        tk.Label(self.frame, text="Valor:").grid(row=6, column=1, columnspan=2, pady=5)
        self.txtValor = tk.Entry(self.frame)
        self.txtValor.grid(row=7, column=1, columnspan=2, padx=30, pady=5)

        tk.Label(self.frame, text="ID:").grid(row=8, column=1, columnspan=2, pady=5)
        self.txtId = tk.Entry(self.frame)
        self.txtId.grid(row=9, column=1, columnspan=2, padx=30, pady=5)

        # Botones para CRUD
        self.btnAgregar = tk.Button(self.frame, text="Agregar Servicio", command=self.agregar_servicio)
        self.btnAgregar.grid(row=10, column=0, pady=20, padx=10, sticky='ew')

        self.btnActualizar = tk.Button(self.frame, text="Actualizar Servicio", command=self.actualizar_servicio)
        self.btnActualizar.grid(row=10, column=1, pady=20, padx=10, sticky='ew')

        self.btnLimpiar = tk.Button(self.frame, text="Limpiar Campos", command=self.limpiar_campos)
        self.btnLimpiar.grid(row=10, column=2, pady=20, padx=10, sticky='ew')
        ...
        self.bntConsultar.grid(row=10, column=3, pady=20, padx=10, sticky='ew')
